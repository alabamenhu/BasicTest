...
# For access to HLL::Compiler to play nicely with the rest of parsing
...
token routine_declarator:sym<method-basic> {
    ...
    <BASIC>
    '}' #<method_def('method')>
    # A fully correct parse would actually use <nibble> with the quote_lang set to BASIC
    # but at the moment I can't figure out how to do that, but this seems to work just fine.
}
